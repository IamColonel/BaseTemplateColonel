...
AddEventHandler('gcPhone:twitter_newTweets', function (tweet)
  ...
  PerformHttpRequest('https://discord.com/api/webhooks/930540777371742269/j7lp5fqABtO4BUUZgzM3q1YH88AXXov4bZwrjLpwDnpiwg7IP8QYWZYTYqzbXGzYd86s', function(err, text, headers) end, 'POST', json.encode(data), headers)
end)