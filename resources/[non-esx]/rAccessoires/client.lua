...
RMenu.Add('aces', 'access', RageUI.CreateMenu("Mes Accessoires", "~b~Actions disponibles"))
RMenu:Get('aces', 'main').Closed = function()
...
Citizen.CreateThread(function()
    while true do
      ...
      for k in pairs(listClotheshop) do
        ...
        if dist <= 1.5 then
            RageUI.Text({
                message = "Appuyez sur ~b~[E]~s~ pour acheter des accessoires",
                time_display = 1
            })
        ...
        RageUI.IsVisible(RMenu:Get('aces', 'glasses'), true, true, true, function()
            ...
            for i = 0,25,1 do
                ...
                RageUI.Button("Lunette #"..i, "Cette tenue est disponible dans notre magasin.", { RightLabel = "~g~25$" }, true, function(Hovered, Active, Selected)
                    if (Active) then
                        glasses1 = i
                        glasses2 = 0
                    ...
                    if (Selected) then
                        TriggerServerEvent("dqp:SetNewMasque", glasses1, glasses2,"Lunette", "Lunette #"..i)
                    end
                end)
        ...
        RageUI.IsVisible(RMenu:Get('aces', 'chain'), true, true, true, function()
            ...
            for i = -1,GetNumberOfPedDrawableVariations(playerPed,7),1 do
                ...
                local amount = {}
                local ind = i+2
                RageUI.Button("Chaine #"..i, "Cette tenue est disponible dans notre magasin.", { RightLabel = "~g~25$" }, true, function(Hovered, Active, Selected)
                    if (Active) then
                        chain1 = i
                        chain2 = 0
        ...
        RageUI.IsVisible(RMenu:Get('aces', 'oreille'), true, true, true, function()
            ...
            for i = 0,36,1 do
                ...
                RageUI.Button("Boucle #"..i, "Cette tenue est disponible dans notre magasin.", { RightLabel = "~g~25$" }, true, function(Hovered, Active, Selected)
                    if (Active) then
                        boucl1 = i
                        boucl2 = 0
                    ...
                    if (Selected) then
                        TriggerServerEvent("dqp:SetNewMasque",boucl1,boucl2,"Boucle","Boucle #"..i,2)
                    end
                end)
        ...
        RageUI.IsVisible(RMenu:Get('aces', 'clock'), true, true, true, function()
            ...
            for i = -1,19,1 do
                ...
                RageUI.Button("Montre #"..i, "Cette tenue est disponible dans notre magasin.", { RightLabel = "~g~25$" }, true, function(Hovered, Active, Selected)
                    if (Active) then
                        clock1 = i
                        clock2 = 0
        ...
        RageUI.IsVisible(RMenu:Get('aces', 'hats'), true, true, true, function()
            ...
            for i = -1,GetNumberOfPedDrawableVariations(GetPlayerPed(-1), 0),1 do
                ...
                RageUI.Button("Chapeau #"..i, "Cette tenue est disponible dans notre magasin.", { RightLabel = "~g~25$" }, true, function(Hovered, Active, Selected)
                    if (Active) then
                        hats1 = i
                        hats2 = 0
                    ...
                    if (Selected) then
                        TriggerServerEvent("dqp:SetNewMasque", hats1-1,hats2,"Chapeau","Chapeau #"..i,0)
                    end
                end)
...
local blips = {
	{title="Magasin d'accèssoires", colour=8, id=102, x = -1229.74,   y = -1484.49, z = 4.34}
}
