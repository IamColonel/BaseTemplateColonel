        ...
        if Config.JSFourIDCard then
            ...
            RageUI.IsVisible(Mvetements, true, true, true, function()
              ...
              RageUI.ButtonWithStyle("Sac", nil, {RightBadge = RageUI.BadgeStyle.Clothes}, true, function(Hovered, Active,Selected)
               ...
               RageUI.ButtonWithStyle("Mes accessoires", nil, {RightBadge = RageUI.BadgeStyle.Clothes}, true, function(Hovered, Active,Selected)
                if (Selected) then
                    RageUI.CloseAll()
                    exports.rAccessoires:openMenuAccessoires()
                end 
            end)
...
RegisterNetEvent('rPersonalmenu:lunettes')
AddEventHandler('rPersonalmenu:lunettes', function()
    ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skina)
        TriggerEvent('skinchanger:getSkin', function(skinb)
            local lib, anim = 'clothingtie', 'try_tie_neutral_a'
            ESX.Streaming.RequestAnimDict(lib, function()
...
RegisterNetEvent('rPersonalmenu:casque')
AddEventHandler('rPersonalmenu:casque', function()
    ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skina)
        TriggerEvent('skinchanger:getSkin', function(skinb)
            local lib, anim = 'clothingtie', 'try_tie_neutral_a'
            ESX.Streaming.RequestAnimDict(lib, function()
            ...
            if skina.helmet_1 ~= skinb.helmet_1 then
                ...
                TriggerEvent('skinchanger:loadClothes', skinb, {['helmet_1'] = 0, ['helmet_2'] = 0})
            end
        end)
    end)
end)
